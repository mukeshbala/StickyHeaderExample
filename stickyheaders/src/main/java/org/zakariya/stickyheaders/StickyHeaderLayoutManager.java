...
@SuppressWarnings("unused") public class StickyHeaderLayoutManager
   ...
   */
  @Nullable public SectioningAdapter.ItemViewHolder getFirstVisibleItemViewHolder(
   ...
   */
  @Nullable public SectioningAdapter.HeaderViewHolder getFirstVisibleHeaderViewHolder(
      boolean fullyVisibleOnly) {
   ...
   */
  @Nullable public SectioningAdapter.FooterViewHolder getFirstVisibleFooterViewHolder(
      boolean fullyVisibleOnly) {
    return (SectioningAdapter.FooterViewHolder) getFirstVisibleViewHolderOfType(
        SectioningAdapter.TYPE_FOOTER, fullyVisibleOnly);
  }

  @Nullable SectioningAdapter.ViewHolder getFirstVisibleViewHolderOfType(int baseType,
      boolean fullyVisibleOnly) {
    if (getChildCount() == 0) {
      return null;
    }
  ...
  void recycleViewsOutOfBounds(RecyclerView.Recycler recycler) {
    ...
    for (int i = 0; i < numChildren; i++) {
      ...
      if (getViewBaseType(view) == SectioningAdapter.TYPE_HEADER && !remainingSections.contains(
          sectionIndex)) {
